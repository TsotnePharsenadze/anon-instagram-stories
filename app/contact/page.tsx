...
export default function Contact() {
  ...
  return (
    <div className="flex flex-col items-center sm:p-6 max-w-4xl mx-auto text-gray-800 my-12 bg-white rounded-md shadow-md">
      <div className="p-8 flex flex-col items-center max-w-screen-md mx-auto customEditForContactUsCardWrapper">
        <Card className="w-full customEditForContactUsCard border-0 shadow-none">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-gray-700">
                ...
                feedback, or have questions about InstaViewer, please fill out
